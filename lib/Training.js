...
class Training {
  ...
  static fromProps(props) {
    return new Training(props.name, props.email, props.category, props.subcategory, props.topic, props.date, props.cellLabel);
  }
...
`;
  ...
  formatCategoryTopicDate() {
    return `${this.category ? `**${this.category}**: ` : ""}${this.formatTopic()} _(last completed ${this.date})_`;
  }
